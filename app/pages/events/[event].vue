  ...
  <article class="event">
    <header class="event__header">
      ...
      <div class="event__about">
        ...
        <div class="event__info">
          <div v-if="datetime" class="event__time-line">
            <span class="event__time">{{ datetime.time }}</span>
            <span class="event__caption">начало</span>
          </div>
    ...
    <div class="event__reservation">
      <div class="event__reservation-layout">
        <div class="event__reservation-inner">
          <h3 class="event__reservation-title">Забронировать столик</h3>
          <ul class="event__tables">
            <li v-for="table in tables" :key="table.id" class="event__table-item">
              <label
                :class="[
                  'table-label',
                  table.price === 1400 ? 'price--red' : 'price--black',
                  table.id === 5 ? 'table-label--table5' : '',
                ]"
              >
                <input
                  type="checkbox"
                ...
                />
                <span class="table-square" aria-hidden="true"></span>
                <span class="table-name">{{ table.id }} стол</span>
              </label>
            </li>
          </ul>

          <div class="event__selection">
            <h4>Ваши приглашательные билеты</h4>
            <ul class="ticket-summary">
              <li v-for="line in summaryLines" :key="line.price">
                <span>{{ line.count }} шт. | {{ line.price }} ₽</span>
                <span class="table-cost">{{ line.total }} ₽</span>
              </li>
            </ul>

            <div class="event__sum">
              <span>Сумма</span>
              <strong>{{ total }} ₽</strong>
            </div>

            <button class="btn btn--red">Купить билеты</button>
          </div>
        </div>

        <div class="event__reservation-map" aria-hidden="true">
          <div class="event__stage-label">Сцена</div>
          <svg
            viewBox="0 0 780 399"
            ...
            fill="none"
          >
            <rect id="карта_заведения" width="780" height="399" x="0" y="0" />
            <g id="Группа 1">
              <path
                id="Вектор 1"
              ...
              <path
                id="Вектор 2"
                d="M362.453 89L360.586 89L360.586 79.1797L357.227 79.1797L357.227 77.5781L365.812 77.5781L365.812 79.1797L362.453 79.1797L362.453 89ZM372.781 89L372.414 87.7969L372.352 87.7969C371.935 88.3229 371.516 88.6823 371.094 88.875C370.672 89.0625 370.13 89.1562 369.469 89.1562C368.62 89.1562 367.956 88.9271 367.477 88.4688C367.003 88.0104 366.766 87.362 366.766 86.5234C366.766 85.6328 367.096 84.9609 367.758 84.5078C368.419 84.0547 369.427 83.8073 370.781 83.7656L372.273 83.7188L372.273 83.2578C372.273 82.7057 372.143 82.2943 371.883 82.0234C371.628 81.7474 371.229 81.6094 370.688 81.6094C370.245 81.6094 369.82 81.6745 369.414 81.8047C369.008 81.9349 368.617 82.0885 368.242 82.2656L367.648 80.9531C368.117 80.7083 368.63 80.5234 369.188 80.3984C369.745 80.2682 370.271 80.2031 370.766 80.2031C371.865 80.2031 372.693 80.4427 373.25 80.9219C373.812 81.401 374.094 82.1536 374.094 83.1797L374.094 89L372.781 89ZM370.047 87.75C370.714 87.75 371.247 87.5651 371.648 87.1953C372.055 86.8203 372.258 86.2969 372.258 85.625L372.258 84.875L371.148 84.9219C370.284 84.9531 369.654 85.099 369.258 85.3594C368.867 85.6146 368.672 86.0078 368.672 86.5391C368.672 86.9245 368.786 87.224 369.016 87.4375C369.245 87.6458 369.589 87.75 370.047 87.75ZM378.492 80.3594L378.492 83.8281L382.562 83.8281L382.562 80.3594L384.398 80.3594L384.398 89L382.562 89L382.562 85.2734L378.492 85.2734L378.492 89L376.656 89L376.656 80.3594L378.492 80.3594ZM394.727 87.5781L395.977 87.5781L395.977 92.0391L394.25 92.0391L394.25 89L387.031 89L387.031 80.3594L388.867 80.3594L388.867 87.5469L392.891 87.5469L392.891 80.3594L394.727 80.3594L394.727 87.5781ZM405.102 80.3594L405.102 89L403.258 89L403.258 81.8125L399.383 81.8125L399.383 89L397.547 89L397.547 80.3594L405.102 80.3594ZM415.398 84.6641C415.398 86.0755 415.036 87.1771 414.312 87.9688C413.589 88.7604 412.581 89.1562 411.289 89.1562C410.482 89.1562 409.768 88.974 409.148 88.6094C408.529 88.2448 408.052 87.7214 407.719 87.0391C407.385 86.3568 407.219 85.5651 407.219 84.6641C407.219 83.263 407.578 82.1693 408.297 81.3828C409.016 80.5964 410.029 80.2031 411.336 80.2031C412.586 80.2031 413.576 80.6068 414.305 81.4141C415.034 82.2161 415.398 83.2995 415.398 84.6641ZM409.109 84.6641C409.109 86.6589 409.846 87.6562 411.32 87.6562C412.779 87.6562 413.508 86.6589 413.508 84.6641C413.508 82.6901 412.773 81.7031 411.305 81.7031C410.534 81.7031 409.974 81.9583 409.625 82.4688C409.281 82.9792 409.109 83.7109 409.109 84.6641ZM424.617 89L422.766 89L422.766 81.7969L420.383 81.7969C420.237 83.651 420.039 85.099 419.789 86.1406C419.544 87.1823 419.221 87.9427 418.82 88.4219C418.424 88.901 417.909 89.1406 417.273 89.1406C416.872 89.1406 416.536 89.0833 416.266 88.9688L416.266 87.5312C416.458 87.6042 416.651 87.6406 416.844 87.6406C417.375 87.6406 417.792 87.0443 418.094 85.8516C418.401 84.6536 418.641 82.8229 418.812 80.3594L424.617 80.3594L424.617 89Z"
                fill="rgb(255,255,255)"
                fill-rule="nonzero"
              />
            </g>
            <g :class="tableMapClass(1)">
              <g id="Группа 3">
                <rect
                  id="Прямоугольник 1"
                  class="table-map__shape"
                  width="83"
                  height="28"
                  x="507.5"
                  y="35.5"
            ...
            <g :class="tableMapClass(3)">
              ...
              <path
                id="Вектор 5"
                class="table-map__label"
                d="M737.479 229.818C737.479 230.704 737.208 231.465 736.668 232.104C736.128 232.735 735.346 233.194 734.324 233.48L734.324 233.539C736.707 233.839 737.898 234.965 737.898 236.918C737.898 238.246 737.371 239.291 736.316 240.053C735.268 240.814 733.81 241.195 731.941 241.195C731.173 241.195 730.46 241.14 729.803 241.029C729.152 240.919 728.445 240.717 727.684 240.424L727.684 237.221C728.309 237.54 728.943 237.777 729.588 237.934C730.239 238.083 730.838 238.158 731.385 238.158C732.231 238.158 732.846 238.041 733.23 237.807C733.621 237.566 733.816 237.191 733.816 236.684C733.816 236.293 733.715 235.993 733.514 235.785C733.312 235.57 732.986 235.411 732.537 235.307C732.088 235.196 731.502 235.141 730.779 235.141L729.9 235.141L729.9 232.24L730.799 232.24C732.758 232.24 733.738 231.739 733.738 230.736C733.738 230.359 733.592 230.079 733.299 229.896C733.012 229.714 732.625 229.623 732.137 229.623C731.225 229.623 730.281 229.929 729.305 230.541L727.703 227.963C728.458 227.442 729.23 227.071 730.018 226.85C730.812 226.628 731.72 226.518 732.742 226.518C734.22 226.518 735.379 226.811 736.219 227.396C737.059 227.982 737.479 228.79 737.479 229.818Z"
                fill="rgb(31,30,30)"
                fill-rule="nonzero"
              />
              <rect
            ...
            <g :class="tableMapClass(4)">
              ...
              <path
                id="Вектор 6"
                class="table-map__label"
                d="M554.416 199.236L552.844 199.236L552.844 202L549.035 202L549.035 199.236L543.342 199.236L543.342 196.404L549.279 187.723L552.844 187.723L552.844 196.355L554.416 196.355L554.416 199.236ZM549.035 196.355L549.035 194.695C549.035 194.383 549.045 193.963 549.064 193.436C549.09 192.902 549.11 192.622 549.123 192.596L549.016 192.596C548.794 193.097 548.544 193.566 548.264 194.002L546.682 196.355L549.035 196.355Z"
                fill="rgb(188,51,36)"
                fill-rule="nonzero"
              />
              <rect
            ...
            <g :class="tableMapClass(6)">
              ...
              <rect
                ...
                x="246"
                y="278"
                opacity="0.00999999978"
                fill="rgb(0,0,0)"
                fill-opacity="0"
              />
            </g>
            <g :class="tableMapClass(7)">
              <g id="Группа 15">
                <rect
                  id="Прямоугольник 13"
                  class="table-map__shape"
              ...
              <path
                id="Вектор 9"
                class="table-map__label"
                d="M358.041 204L362.943 192.916L356.762 192.916L356.762 189.723L367.064 189.723L367.064 191.998L362.035 204L358.041 204Z"
                fill="rgb(188,51,36)"
                fill-rule="nonzero"
              />
              <rect
            ...
            <g :class="tableMapClass(8)">
              <g id="Группа 17">
                ...
                <circle
                  ...
                  r="11.5"
                  stroke-width="1"
                  transform="matrix(-1,0,0,-1,227.5,232.5)"
                />
                <circle
                  id="Эллипс 44"
                  class="table-map__shape"
                  ...
                  r="11.5"
                  stroke-width="1"
                  transform="matrix(-1,0,0,-1,182.5,196.5)"
                />
                <circle
                  id="Эллипс 45"
                  class="table-map__shape"
                  ...
                  r="11.5"
                  stroke-width="1"
                  transform="matrix(-1,0,0,-1,227.5,165.5)"
                />
              </g>
              <path
                id="Вектор 10"
            ...
            <g :class="tableMapClass(9)">
              <g id="Группа 19">
                ...
                <circle
                  ...
                  r="11.5"
                  stroke-width="1"
                  transform="matrix(-1,0,0,-1,262.5,90.5)"
                />
                <circle
                  id="Эллипс 47"
                  class="table-map__shape"
                  ...
                  r="11.5"
                  stroke-width="1"
                  transform="matrix(-1,0,0,-1,217.5,54.5)"
                />
                <circle
                  id="Эллипс 48"
                  class="table-map__shape"
            ...
            <g :class="tableMapClass(10)">
              <g id="Группа 21">
                <path
                  id="Вектор 12"
                  class="table-map__shape"
                  d="M110.5 0.5L141.5 0.5L141.5 64.8261L141.5 92.5L15.5 92.5L15.5 65.5L110 65.5L110.5 65.5L110.5 65L110.5 0.5Z"
                  fill-rule="nonzero"
                  stroke-width="1"
                />
                <circle
            ...
            <g :class="tableMapClass(11)">
              ...
              <path
                id="Вектор 14"
                class="table-map__label"
                d="M45.1992 241L41.2832 241L41.2832 233.441C41.2832 232.523 41.3027 231.684 41.3418 230.922C41.1009 231.215 40.8014 231.521 40.4434 231.84L38.8223 233.178L36.8203 230.717L41.7227 226.723L45.1992 226.723L45.1992 241ZM56.918 241L53.002 241L53.002 233.441C53.002 232.523 53.0215 231.684 53.0605 230.922C52.8197 231.215 52.5202 231.521 52.1621 231.84L50.541 233.178L48.5391 230.717L53.4414 226.723L56.918 226.723L56.918 241Z"
                fill="rgb(31,30,30)"
                fill-rule="nonzero"
              />
              <rect
          ...
          <div class="event__legend">
            <div class="legend-prices">
              <h4 class="legend-title">Стоимость приглашательного билета</h4>
              <ul>
                <li>
                  <span class="legend-swatch swatch-red" aria-hidden="true"></span>
                  <span class="legend-text">1400 ₽ | 1 персона</span>
                </li>
                <li>
                  <span class="legend-swatch swatch-black" aria-hidden="true"></span>
                  <span class="legend-text">1250 ₽ | 1 персона</span>
                </li>
              </ul>
            </div>

            <div class="legend-notes">
              <h4 class="legend-title">Примечание</h4>
              <ul>
                <li>
                  <span class="legend-dot available" aria-hidden="true"></span>
                  <span class="legend-text">доступные места</span>
                </li>
                <li>
                  <span class="legend-dot reserved" aria-hidden="true"></span>
                  <span class="legend-text">забронировано</span>
                </li>
              </ul>
            </div>
          </div>
...
const URL = computed(() => `http://localhost:3000/json/events/${slug.value}.json`);
...
// Reservation tables data (static for this event)
const tables = [
  { id: 1, seats: 5, price: 1400, available: true },
  { id: 2, seats: 7, price: 1250, available: true },
  { id: 3, seats: 7, price: 1250, available: true },
  { id: 4, seats: 5, price: 1400, available: true },
  { id: 5, seats: 6, price: 1400, available: false },
  { id: 6, seats: 7, price: 1250, available: true },
  { id: 7, seats: 5, price: 1400, available: true },
  { id: 8, seats: 3, price: 1400, available: true },
  { id: 9, seats: 3, price: 1400, available: true },
  { id: 10, seats: 4, price: 1250, available: true },
  { id: 11, seats: 7, price: 1250, available: true },
];

const selected = ref([]);

const findTable = (id) => tables.find((t) => t.id === id) || { seats: 0, price: 0 };
...
const summaryLines = computed(() => {
  ...
  selected.value.forEach((id) => {
    ...
    const existing = totals.get(table.price) || { count: 0, total: 0 };
    existing.count += table.seats;
    existing.total += table.seats * table.price;
    totals.set(table.price, existing);
  });

  return Array.from(totals.entries())
    .map(([price, data]) => ({ price, count: data.count, total: data.total }))
...
const total = computed(() => {
  return selected.value.reduce((sum, id) => {
    ...
    return sum + t.seats * t.price;
  }, 0);
});

const tableMapClass = (id) => {
  const table = findTable(id);

  return {
    "table-map": true,
    "table-map--active": selected.value.includes(id),
    "table-map--disabled": !table.available,
    "table-map--table5": id === 5,
    "price--red": table.price === 1400,
    "price--black": table.price === 1250,
  };
};
</script>
...
<style lang="less">
.event {
  /* Styles are added separately. */
}
 
/* Ensure header image on event page is not cropped — keep natural aspect ratio */
.event__picture {
